...
GOOGLE_FORM_RESPONSE = "https://docs.google.com/forms/d/e/" \
                       "1FAIpQLSdQlyYBnXqLYCQReMNrQ6Mzp7L1xAWkW9ymZ4oixS5lx7AY1A/formResponse"

# Xpaths variables for locations
...
# Headers - needed for Zillow specifically
HEADERS = {
...
# All information for running selenium
# ignoring exceptions as they have come up sometimes when locating an element
...
# These were used specifically b/c I kept running into a problem where each find_element function wouldn't allow for --
# DOM to load -- so now each function runs a wait.until func that allows for the DOM to load first
# I can pinpoint which function is not working via timeout with exception handling.
